...
| ENG-004 | Identity tenancy layout: users/organizations platform-scoped; tenancy binds via memberships/roles (org-scoped); session binds ≤1 active tenant | BP-003: authentication platform-wide, authorization tenant-scoped | Table design for `apps/identity`; pattern for future platform-scoped aggregates | ADR-001 #8 | LOG-S002; BP-003 §8 | Accepted (Sprint-002) |
| ENG-005 | **(Corrected at closure)** Sprint-002 executed against the PO's inline scope directive without loading IP-002. Original premise "IP-002 unauthored" was FALSE — IP-002 (2026-07-08, 849 lines) existed; stale CLAUDE.md state was trusted over a directory check (process finding P-1, CLS-002 §3). Conformance assessed at closure; as-built + ratified divergences D-1..D-4 recorded in IP-002 §31 addendum | PO directive was a strict subset of IP-002 scope; no conflict resulted | Obligation **discharged** via IP-002 §31 As-Built Addendum; residual duty: correct CLAUDE.md §2 IP status table | — | LOG-S002; CLS-002; IP-002 §31 | Accepted; discharged (2026-07-19) |
