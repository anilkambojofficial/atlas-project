...
| ENG-005 | Sprint-002 executed against the PO's inline scope directive (2026-07-19); IP-002 document authoring deferred to as-built documentation | IP-002 was unauthored at sprint start; PO directive supplied complete scope | **Open obligation: author IP-002 from as-built** before Sprint-003 planning | — | LOG-S002 | Accepted; obligation open |
